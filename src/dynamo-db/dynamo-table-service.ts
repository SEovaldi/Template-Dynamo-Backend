...
export class DynamoDBTableService {
  ...
  public async describeTable(params: AWS.DynamoDB.DescribeTableInput): Promise<AWS.DynamoDB.DescribeTableOutput> {
    return new Promise((resolve, reject) => {
  ...
  public async updateTable(params: AWS.DynamoDB.UpdateTableInput): Promise<AWS.DynamoDB.UpdateTableOutput> {
    return new Promise((resolve, reject) => {
  ...
  public async listTables(params: AWS.DynamoDB.ListTablesInput): Promise<AWS.DynamoDB.ListTablesOutput> {
    return new Promise((resolve, reject) => {
